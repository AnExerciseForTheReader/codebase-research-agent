    ...
    if _client is None:
        ...
        "filesystem": {
            ...
            "args": [
                ...
                repo_path  # Path to research documents
            ],
...
async def tool_node(state: ResearcherState):
    ...
    async def execute_tools():
        ...
        for tool_call in tool_calls:
            ...
            if "path" in args and os.path.isdir(args["path"]) and tool_call["name"] == "read_file":
                observations.append(f"Skipped: {args['path']} is a directory, not a file. Use list_dir instead.")
                continue
            ...
            if tool_call["name"] == "think_tool":
                ...
                try:
                    ...
                    observation = f"Error: failed to run {tool_call['name']} with args {tool_call['args']}. Exception: {e}"
